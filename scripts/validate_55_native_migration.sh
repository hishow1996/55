...
grep -Fq 'Elephant55NativeSettings.applyKiwiUiDefaults(this);' "$KIWI/chrome/android/java/src/org/chromium/chrome/browser/ChromeTabbedActivity.java" || fail "55 Kiwi UI defaults hook missing"
